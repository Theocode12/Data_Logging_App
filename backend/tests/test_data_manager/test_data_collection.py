...
from models.data_manager.data_collection import DataCollectionManager, FileDB
...
class TestDataCollectionManager(unittest.TestCase):
    def setUp(self):
        with patch.object(DataCollectionManager, "set_database_path"):
    ...
    def test_add_data_models(self):
        # Test adding data models to the set
        mock_data_model = MagicMock()
        self.data_collection_manager.add_data_models([mock_data_model])
        self.assertEqual(len(self.data_collection_manager.data_models), 1)
